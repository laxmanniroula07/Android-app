        ...
        storageReference.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                if (urlImage != null) {
                    ...
                    Toast.makeText(Upload.this, "Failed to retrieve download URL", Toast.LENGTH_SHORT).show();
                }
                dialog.dismiss();
            }
            ...
            public void onFailure(@NonNull Exception e) {
                dialog.dismiss();
                Toast.makeText(Upload.this, "Failed to upload image: " + e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void uploadData(){
        ...
        FirebaseDatabase.getInstance().getReference("Android Tutorials").child(currentDate)
                .setValue(dataClass).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(Upload.this, "Failed to save data: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
}