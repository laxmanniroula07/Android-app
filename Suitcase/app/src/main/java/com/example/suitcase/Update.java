...
public class Update extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateprice = findViewById(R.id.updatepri);
        updateTitle = findViewById(R.id.updateTitle);

        ActivityResultLauncher<Intent> activityResultLauncher = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), new androidx.activity.result.ActivityResultCallback<ActivityResult>() {
            @Override
        ...
        if (bundle != null){
            ...
            updateprice.setText(bundle.getString("Language"));
